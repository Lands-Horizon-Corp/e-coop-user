...
export const resizeImage = async (
    ...
    // 2. Create and setup Source Canvas
    ...
    // 3. Create and setup Target Canvas
    const targetCanvas: HTMLCanvasElement = document.createElement('canvas')
    targetCanvas.width = width
    targetCanvas.height = height

    // 4. Resize via Pica
    // Pica expects HTMLCanvasElement or OffscreenCanvas
    ...
    // 5. Export as Blob
    const resizedBlob = await pica.toBlob(targetCanvas, 'image/jpeg', 0.9)
