...
export default function Policies() {
  ...
  <div className="rounded-2xl border border-white/10 bg-black/10 p-6 text-sm text-teal-50/70 leading-relaxed">
    Welcome to e-coop-suite. This Privacy Policy describes how Lands Horizon Corp
    collects, uses, stores and protects your personal information through the platform.
  ...
  {[
...

    {
      ...
      body: (
        <p>
          Data is retained during membership plus up to five (5) years after closure,
...

    {
      ...
      body: (
        <p>
          No international transfers currently. Cookies are used for analytics,
          security, and UX. No intentional child data collection. Policy updates
          are communicated through email or platform notice.
        </p>
      )
    },

    {
      ...
      body: (
        <div className="space-y-1">
          ...
          <p>Email: lands.horizon.corp@gmail.com</p>
