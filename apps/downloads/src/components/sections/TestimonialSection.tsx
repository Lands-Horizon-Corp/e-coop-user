...
const testimonials: Testimonial[] = [
    {
        ...
        content:
            'E-Cooperative Suite has completely transformed how we manage our members. The AI-powered insights have helped us make better financial decisions and grow our cooperative by 40% in just one year.',
        rating: 5,
        avatar: 'MS',
    },
    {
        ...
        content:
            "The transaction management system is incredibly intuitive. We've reduced our administrative workload by 60% and our members love the mobile accessibility. Highly recommended!",
        rating: 5,
        avatar: 'JD',
    },
    {
        ...
        content:
            'Security was our top concern, and E-Cooperative Suite exceeded our expectations. The enterprise-grade protection gives us and our members complete peace of mind.',
        rating: 5,
        avatar: 'AR',
    },
    {
        ...
        content:
            'The reporting features are outstanding. We can generate comprehensive reports in seconds that used to take days. This has revolutionized our quarterly meetings.',
        rating: 5,
        avatar: 'RL',
    },
    {
        ...
        content:
            'From member onboarding to transaction processing, everything is seamless. The support team is responsive and the platform keeps getting better with updates.',
        rating: 5,
        avatar: 'CG',
    },
]
                    ...
                    <div className="text-center mb-16">
                        ...
                        <AnimatedSection animation="fadeUp" delay={0.2}>
                            <p className="mt-4 text-base text-teal-100/50 max-w-2xl mx-auto">
                                Discover how cooperatives across the Philippines
                                are transforming their operations with
                                E-Cooperative Suite.
                            </p>
                        </AnimatedSection>
                    </div>
                        ...
                        {stats.map((stat, index) => (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="text-sm text-teal-100/50 mt-1">
                                        {stat.label}
                                    </div>
                                </motion.div>
                            </AnimatedSection>
