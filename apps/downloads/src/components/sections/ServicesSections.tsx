        ...
        <div className="relative" style={{ transformStyle: 'preserve-3d' }}>
            <div
                ...
                style={{
                    ...
                    filter: 'blur(8px)',
                    transform:
                        'translate(-50%, 50%) rotateX(70deg) scaleY(0.3)',
                }}
            />
            ...
            `,
                ...
                >
                    <div
                        ...
                        style={{
                            boxShadow:
                                'inset 0 0 10px rgba(0,0,0,0.2), 0 0 5px rgba(255,255,255,0.2)',
                        }}
                    />
                    ...
                    <span
                        ...
                        style={{
                            color: 'transparent',
                            background:
                                'linear-gradient(to bottom, #ffffff 0%, #d1fae5 50%, #ffffff 100%)',
                            WebkitBackgroundClip: 'text',
                            backgroundClip: 'text',
                            textShadow:
                                '0 2px 4px rgba(0,0,0,0.4), 0 -1px 2px rgba(255,255,255,0.9)',
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white leading-tight">
                                What are{' '}
                                <span className="text-emerald-400">you</span> up
                                to?
                            </h2>
