        ...
        <div className="px-6 md:px-10 pt-32 pb-20">
          <div className="mx-auto max-w-6xl text-center">
            ...
            <p className="mt-8 text-base md:text-lg text-teal-100/75 max-w-3xl mx-auto leading-relaxed">
              a next-generation. integrated cloud-based cooperative management platform. 
              eCOOP SUITE transforms the cooperative experience for members, 
              clients, staff, and officers by providing a friendly, intuitive, and accessible platform.
            </p>
