...
const MemberCard = () => (
    <div className="h-full flex flex-col p-4">
        ...
        <div className="flex gap-1.5 mt-auto">
            {[...Array(4)].map((_, i) => (
                <div
                    className="w-5 h-5 rounded-full bg-linear-to-br from-emerald-400/30 to-emerald-600/30 border border-white/10 flex items-center justify-center text-[8px] text-white/70"
                    key={i}
                >
...
const ReportCard = () => (
    <div className="h-full flex flex-col p-4">
        ...
        <div className="text-[11px] text-teal-100/50 mb-3">
            Reports Generated
        </div>
        ...
        <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
                ...
                <div>
                    ...
                    <div className="text-xs text-teal-100/50">
                        Active Applications
                    </div>
                </div>
            </div>
