...
export default function DownloadSection() {
    ...
    const currentPackage =
        currentPackages.find((p) => p.type === selectedPackage) ||
        currentPackages[0]

    const handleOSSelect = (os: OS) => {
        setSelectedOS(os)
        // Set default package for the OS
                        ...
                        <div>
                            ...
                            <AnimatedSection animation="fadeUp" delay={0.2}>
                                <p className="mt-6 text-base text-teal-100/60 max-w-lg leading-relaxed">
                                    ...
                                    native desktop application. Manage member
                                    records, process transactions, generate
                                    reports, and receive real-time
                                    notifications—optimized for administrative
                                    workflows.
                                </p>
                            </AnimatedSection>
                            ...
                            <AnimatedSection animation="fadeUp" delay={0.3}>
                                <div className="mt-10">
                                    <p className="text-sm text-teal-100/50 mb-4">
                                        Choose your platform
                                    </p>
                                    <div className="flex flex-wrap gap-3">
                                        {(Object.keys(OS_META) as OS[]).map(
                                            (os) => {
                            ...
                            <AnimatedSection animation="fadeUp" delay={0.4}>
                                <div className="mt-6 relative">
                                    <p className="text-sm text-teal-100/50 mb-3">
                                        Select package type
                                    </p>
                                    <div className="relative">
                                        ...
                                        >
                                            <span className="flex items-center gap-2">
                                                ...
                                                <span className="text-teal-100/40 text-xs">
                                                    ({currentPackage.size})
                                                </span>
                                            </span>
                                            <ChevronDown
                                                    ...
                                                    {currentPackages.map(
                                                        (pkg) => (
                                                            ...
                                                            >
                                                                ...
                                                                <span className="text-xs text-teal-100/40">
                                                                    {pkg.size}
                                                                </span>
                                                            </button>
                                                        )
                                ...
                                <AnimatePresence mode="wait">
                                    ...
                                    >
                                        <div className="rounded-3xl overflow-hidden bg-black/40 backdrop-blur-xl border border-white/10 shadow-2xl">
                                            ...
                                            {/* Content */}
                                            <div className="p-8">
                                                <div className="h-24 rounded-2xl bg-gradient-to-r from-emerald-500/10 to-teal-500/10 border border-white/5 flex items-center px-6">
                                                ...
                                                <div className="mt-6 h-48 rounded-2xl bg-gradient-to-br from-emerald-500/5 to-teal-500/5 border border-white/5" />
                                            </div>
                                        </div>
                                    </motion.div>
                                </AnimatePresence>
