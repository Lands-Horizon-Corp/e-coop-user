...
export default function ColorPicker({
  ...
  const handleEyeDropper = async () => {
    if (!isEyeDropperAvailable()) {
      toast.warning('Eyedropper is not supported in your browser');
      return;
    }
    try {
      ...
      <div className="flex items-center w-full  gap-4">
        <Popover onOpenChange={handlePopoverChange}>
          <PopoverTrigger asChild>
            <Button
              className="border-border  size-10 border shadow-none relative overflow-hidden"
              size={'icon'}
              ...
              <div className="flex gap-2">
                <Select onValueChange={setColorFormat} value={colorFormat}>
                  ...
                  <SelectContent className="min-w-20">
                    {alpha ? (
                      <>
                        <SelectItem className="text-sm h-7" value="HEXA">
                          HEXA
                        </SelectItem>
                        <SelectItem className="text-sm h-7" value="RGBA">
                          RGBA
                        </SelectItem>
                        <SelectItem className="text-sm h-7" value="HSLA">
                          HSLA
                        </SelectItem>
                      </>
                    ) : (
                      <>
                        <SelectItem className="text-sm h-7" value="HEX">
                          HEX
                        </SelectItem>
                        <SelectItem className="text-sm h-7" value="RGB">
                          RGB
                        </SelectItem>
                        <SelectItem className="text-sm h-7" value="HSL">
                          HSL
                        </SelectItem>
                      </>
                    )}
