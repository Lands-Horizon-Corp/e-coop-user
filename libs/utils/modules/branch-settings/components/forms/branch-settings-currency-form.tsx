import { UseFormReturn, useFieldArray, useForm, Resolver } from 'react-hook-form'
...
const BranchSettingsCurrencyForm = ({
    ...
    const form = useForm<TBranchSettingsCurrencySchema>({
        resolver: zodResolver(BranchSettingsCurrencySchema) as Resolver<TBranchSettingsCurrencySchema>,
