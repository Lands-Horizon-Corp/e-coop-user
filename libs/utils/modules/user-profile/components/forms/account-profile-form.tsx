...
const AccountProfileForm = ({
    ...
    const form = useForm<TAccountProfileFormValues>({
        resolver: zodResolver(UserProfileSchema) as Resolver<TAccountProfileFormValues>,
        ...
        defaultValues: {
            ...
            birthdate: toInputDateString(
                (formProps.defaultValues?.birthdate as Date | string | number | undefined) ?? new Date()
            ),
        },
    })
