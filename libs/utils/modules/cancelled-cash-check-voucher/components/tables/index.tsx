...
import CancelledCashCheckVoucherTableColumns, {
    ICancelledCashCheckVoucherTableColumnProps,
    cancelledCashCheckVoucherGlobalSearchTargets,
} from './columns'
import CancelledCashCheckVoucherAction, {
    CancelledCashCheckVoucherRowContext,
...
const CancelledCashCheckVoucherTable = ({
    className,
    toolbarProps,
    defaultFilter,
    onSelectData,
    ...
    actionComponent = CancelledCashCheckVoucherAction,
    RowContextComponent = CancelledCashCheckVoucherRowContext,
}: CancelledCashCheckVoucherTableProps) => {
    ...
    const columns = useMemo(
        () =>
            CancelledCashCheckVoucherTableColumns({
                actionComponent,
            }),
        [actionComponent]
    )
    ...
    } = useDataTableState<ICancelledCashCheckVoucher>({
...
export default CancelledCashCheckVoucherTable
