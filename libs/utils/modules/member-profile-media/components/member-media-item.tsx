...
const MemberMediaItem = ({
    memberMedia,
    uploadedBy,
    onRemove,
    otherAction,
}: MemberMediaItemProps) => {
    ...
    // Get created date
    const createdDate = media?.created_at || memberMedia.created_at
...
export default MemberMediaItem
export { type MemberMediaItemProps }
