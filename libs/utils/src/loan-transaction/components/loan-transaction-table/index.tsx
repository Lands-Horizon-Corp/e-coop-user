...
import LoanStatusTableColumns, {
    ILoanTransactionTableColumnProps,
    loanStatusGlobalSearchTargets,
} from './columns'
...
const LoanTransactionTable = ({
    ...
    const tableState = useDataTableState<ILoanTransaction>({
        key: finalKeys,
                ...
                >
                    <DataTableToolbar
                        ...
                        exportActionProps={{
                            ...
                            url: 'api/v1/loan-transaction/search',
                        }}
                        filterLogicProps={{
                    ...
                    <LoanTransactionTableActionManager />
                </div>
            </TableRowActionStoreProvider>
