import { IGeneralAccountGroupingNetSurplusPositive, IGeneralAccountGroupingNetSurplusPositiveRequest } from './general-account-grouping-net-surplus-positive.types';
