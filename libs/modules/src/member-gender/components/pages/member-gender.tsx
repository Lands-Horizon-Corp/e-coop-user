...
const MemberGenderPage = () => {
    ...
    useSubscribe('member_gender', `create.branch.${branch_id}`, () => {
        queryClient.invalidateQueries({
            queryKey: ['member-gender', 'paginated'],
        })
    })

    useSubscribe('member_gender', `update.branch.${branch_id}`, () => {
        queryClient.invalidateQueries({
            queryKey: ['member-gender', 'paginated'],
        })
    })

    useSubscribe('member_gender', `delete.branch.${branch_id}`, () => {
        queryClient.invalidateQueries({
            queryKey: ['member-gender', 'paginated'],
        })
    })
