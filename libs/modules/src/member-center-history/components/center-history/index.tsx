...
import { IMemberCenterHistory } from '@/modules/member-center-history/member-center-history.types'
import {
    getCoreRowModel,
    getSortedRowModel,
    useReactTable,
...
import { useGetMemberCenterHistoryById } from '../../member-center-history.service'
...
export interface MemberCenterHistoryTableProps
    extends TableProps<IMemberCenterHistory>, IMemberCenterHistoryColumnProps {
    toolbarProps?: Omit<
...
const MemberCenterHistoryTable = ({
    profileId,
    persistKey = ['member-center-history', profileId],
    className,
    toolbarProps,
