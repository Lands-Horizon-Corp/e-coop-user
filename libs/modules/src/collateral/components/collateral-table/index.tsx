...
import { deleteManyCollateral, useGetPaginatedCollateral } from '../..'
import { ICollateral } from '../../collateral.types'
import CollateralTableColumns, {
    ICollateralTableColumnProps,
    collateralGlobalSearchTargets,
} from './columns'
import CollateralAction, {
    CollateralRowContext,
    CollateralTableActionManager,
...
const CollateralTable = ({
    ...
    const tableState = useDataTableState<ICollateral>({
        key: finalKeys,
