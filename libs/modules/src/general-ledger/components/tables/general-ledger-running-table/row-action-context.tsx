...
const useGeneralLedgerRunningActions = ({
    row,
    onDeleteSuccess,
...
export const GeneralLedgerRunningAction = ({
    row,
    onDeleteSuccess,
}: IGeneralLedgerTableActionProps) => {
    const { handleViewDetails } = useGeneralLedgerRunningActions({
        row,
        onDeleteSuccess,
    })
...
export const GeneralLedgerRunningRowContext = ({
    row,
    children,
    onDeleteSuccess,
...
export const GeneralLedgerRunningTableActionManager = () => {
...
export default GeneralLedgerRunningAction
