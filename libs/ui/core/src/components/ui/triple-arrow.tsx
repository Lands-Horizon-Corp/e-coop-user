...
const TripleArrow: React.FC<TripleArrowProps> = ({
    ...
    return (
        ...
        >
            <div
                className="absolute left-1/2 transform -translate-x-1/2 bg-linear-to-b from-primary/0 via-primary/20 to-primary/40 rounded-tl-full rounded-se-full pointer-events-none overflow-hidden"
                style={{
