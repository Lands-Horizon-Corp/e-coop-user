...
const TransactionBatchEndForm = ({
    ...
    const form = useForm<TTransactionBatchEndFormValues>({
        resolver: zodResolver(TransactionBatchEndSchema) as Resolver<TTransactionBatchEndFormValues>,
    ...
    const onSubmit = form.handleSubmit(async (formData) => {
        onOpenSecurityAction({
            ...
            onSuccess: () => endBatch({
                employee_by_signature_media_id: formData['employee_by_signature_media_id'],
                employee_by_name: formData['employee_by_name'],
                employee_by_position: formData['employee_by_position'],
            }),
        })
    }, handleFocusError)
