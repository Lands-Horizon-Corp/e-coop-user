...
import { useGetPaginatedCashCounts } from '../../cash-count.service'
...
import CashCountAction, {
    CashCountRowContext,
    CashCountTableActionManager,
...
const CashCountTable = ({
    ...
    const tableState = useDataTableState<ICashCount>({
        key: finalKeys,
