...
if (!folderName) {
    console.error(
        'Missing shared folder name. Usage: bun run g:shared <folder_name>'
    )
    process.exit(1)
}
...
const projectRoot = path.join(workspaceRoot, 'libs', 'shared', folderName)
...
console.log(`Shared project is ready: libs/shared/${folderName}`)
