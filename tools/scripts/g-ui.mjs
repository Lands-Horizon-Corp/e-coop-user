...
if (!folderName) {
    console.error('Missing UI folder name. Usage: bun run g:ui <folder_name>')
    process.exit(1)
}
...
const projectRoot = path.join(workspaceRoot, 'libs', 'ui', folderName)
...
console.log(`UI project is ready: libs/ui/${folderName}`)
